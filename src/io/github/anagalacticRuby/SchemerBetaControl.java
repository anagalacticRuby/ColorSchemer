...
public class SchemerBetaControl implements Initializable {
    ...
    @FXML
    private Ellipse gradient1;

    @FXML
    private Button btnTest;

    @FXML
    private ToggleButton toggleStroke;

    @FXML
    private ColorPicker colorPicker;

    @FXML
    private ComboBox<String> comboShapeNum;
    ...
    @FXML
    private Circle circle1S;

    @FXML
    private Circle circle4S;

    @FXML
    private Circle circle2S;

    @FXML
    private Circle circle5S;

    @FXML
    private Circle circle3S;

    @FXML
    private Circle circle6S;
    ...
    void applyColor(MouseEvent event) {
        shapeNum = comboShapeNum.getValue();
        switch (shapeNum) {
            case "Circle 1": {
                //If the toggle stroke button is enabled, it will apply the color to the circle's stroke only.
    ...
    void changeFill2(MouseEvent event) {
         ...
         */
        Stop[] stops = new Stop[]{
                new Stop(0, colorPicker.getValue()), new Stop(1, (Color) circle2.getFill())};
    ...
    public void initialize(URL location, ResourceBundle resources) {
        comboShapeNum.getItems().addAll("Circle 1", "Circle 2", "Circle 3",
